...
var participantsRestants=participants.slice(0); //dupliquer les tableau pour tirage avec suppression

var huitAleatoires1=[]; //pousser un elt de rang aleatoire dans le tableau tant que sa longeur est inferieur a 8
